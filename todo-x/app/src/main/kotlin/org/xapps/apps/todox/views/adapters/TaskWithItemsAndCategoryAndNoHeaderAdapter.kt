...
import org.xapps.apps.todox.databinding.ItemTaskWithItemsAndCategoryAndNoHeaderBinding
import ru.rambler.libs.swipe_layout.SwipeLayout
import timber.log.Timber
import java.time.LocalDate


class TaskWithItemsAndCategoryAndNoHeaderAdapter(
    private val itemListener: ItemListener
): PagingDataAdapter<TaskWithItemsAndCategory, TaskWithItemsAndCategoryAndNoHeaderAdapter.ItemViewHolder>(TaskDiffCallback()) {

    private val currentOpenedMenuItem: ObservableField<ItemTaskWithItemsAndCategoryAndNoHeaderBinding> = ObservableField()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val bindings = ItemTaskWithItemsAndCategoryAndNoHeaderBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class ItemViewHolder(
        private val bindings: ItemTaskWithItemsAndCategoryAndNoHeaderBinding,
        val wrapperCurrentOpenedMenuItem: ObservableField<ItemTaskWithItemsAndCategoryAndNoHeaderBinding>,
